...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">CRUD: Create!</h2>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    >
                        <form @submit.prevent="submit">
                            ...
                            <button type="submit" class="rounded hover:bg-lime-200 bg-green-200 text-green-950 font-bold p-2 border-solid border-2 border-slate-400 dark:border-none">Create</button>
                        </form>
                    </div>
